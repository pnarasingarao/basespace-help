...
# The following is not yet in the demo, but you can still do it
...
Note: This S3 URL is only valid for a certain duration (7 days?) after it got generated by the API call used by BaseMount to create the Content/Url file.
